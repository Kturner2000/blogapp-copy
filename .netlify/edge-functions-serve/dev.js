...
const functions = {}; const metadata = { functions: {} };
      ...
      try {
        const { default: func } = await import("file:///Users/kylie/Documents/Programming/Next%20js/blogapp%20copy/.netlify/edge-functions/next-dev/index.js");

        if (typeof func === "function") {
          functions["next-dev"] = func;
          metadata.functions["next-dev"] = {"url":"file:///Users/kylie/Documents/Programming/Next%20js/blogapp%20copy/.netlify/edge-functions/next-dev/index.js"}
        } else {
